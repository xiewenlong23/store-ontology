...
def _make_customer_with_ontology(tmp_path, customer_id="customer_test"):
    """构造一个有自己 ontology 目录的客户（模拟 ontocopy 后）。"""
    cust_dir = tmp_path / "customers" / customer_id
